                    ...
                    <tbody className="bg-purple-400  text-white font-serif">
                        {passwordArray.map((item, index) => {
                            return <tr key={index}>
                                ...
                                <td className="py-2 border border-white text-center w-32">{item.password} <img onClick={() => { copyText(item.password) }} className='invert cursor-pointer px-5' src="/icons/copy.png" alt="" /></td>
